...
// export const { addItem, removeItem, incrementQuantity, decrementQuantity } = PlantsSlice.actions;
...
//         console.log("plantsArray", plantsArray[0].plants)
//     }, [])

//     const dispatch = useDispatch(); 


//     const handleIncrementPlantQuantity = (index) => {
//         alert("so here, we want to add an item to the cart or update an item in the cart")
//         dispatch(incrementPlantQuantity(index));
//       }; 
  
//       const handleDecrementPlantQuantity = (index) => {
//         dispatch(decrementPlantQuantity(index));
//       };
